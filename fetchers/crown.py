...
class CrownFetcher(CompanyFetcher):
    """Crown Holdings 爬蟲"""

    company_id = "crown"
    company_name = "Crown Holdings"
    news_url = "https://www.crownholdings.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.crownholdings.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Crown Holdings")
        return documents
