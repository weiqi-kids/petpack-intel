...
class IntlPaperFetcher(CompanyFetcher):
    """International Paper 爬蟲"""

    company_id = "intl_paper"
    company_name = "International Paper"
    news_url = "https://www.internationalpaper.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.internationalpaper.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from International Paper")
        return documents
