...
class AmcorFetcher(CompanyFetcher):
    """Amcor 爬蟲"""

    company_id = "amcor"
    company_name = "Amcor"
    news_url = "https://www.amcor.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Amcor")
        return documents
