"""
Packaging Corporation of America 官網爬蟲
"""
...
class PkgFetcher(CompanyFetcher):
    """Packaging Corporation of America 爬蟲"""

    company_id = "pkg"
    company_name = "Packaging Corporation of America"
    news_url = "https://www.packagingcorporationofamerica.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.packagingcorporationofamerica.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Packaging Corporation of America")
        return documents
