...
class TrupanionFetcher(CompanyFetcher):
    """Trupanion 爬蟲"""

    company_id = "trupanion"
    company_name = "Trupanion"
    news_url = "https://www.trupanion.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.trupanion.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Trupanion")
        return documents
