...
class SonocoFetcher(CompanyFetcher):
    """Sonoco Products 爬蟲"""

    company_id = "sonoco"
    company_name = "Sonoco Products"
    news_url = "https://www.sonocoproducts.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.sonocoproducts.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Sonoco Products")
        return documents
