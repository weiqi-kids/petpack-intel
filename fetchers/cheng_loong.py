...
class ChengLoongFetcher(CompanyFetcher):
    """正隆 爬蟲"""

    company_id = "cheng_loong"
    company_name = "正隆"
    news_url = "https://www.正隆.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 正隆")
        return documents
