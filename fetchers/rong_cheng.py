...
class RongChengFetcher(CompanyFetcher):
    """榮成紙業 爬蟲"""

    company_id = "rong_cheng"
    company_name = "榮成紙業"
    news_url = "https://www.榮成紙業.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 榮成紙業")
        return documents
