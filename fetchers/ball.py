...
class BallFetcher(CompanyFetcher):
    """Ball Corporation 爬蟲"""

    company_id = "ball"
    company_name = "Ball Corporation"
    news_url = "https://www.ballcorporation.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.ballcorporation.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Ball Corporation")
        return documents
