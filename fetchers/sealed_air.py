...
class SealedAirFetcher(CompanyFetcher):
    """Sealed Air 爬蟲"""

    company_id = "sealed_air"
    company_name = "Sealed Air"
    news_url = "https://www.sealedair.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.sealedair.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Sealed Air")
        return documents
