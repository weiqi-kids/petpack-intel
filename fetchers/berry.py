...
class BerryFetcher(CompanyFetcher):
    """Berry Global Group 爬蟲"""

    company_id = "berry"
    company_name = "Berry Global Group"
    news_url = "https://www.berryglobalgroup.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.berryglobalgroup.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Berry Global Group")
        return documents
