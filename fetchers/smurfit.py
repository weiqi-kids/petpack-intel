...
class SmurfitFetcher(CompanyFetcher):
    """Smurfit Westrock 爬蟲"""

    company_id = "smurfit"
    company_name = "Smurfit Westrock"
    news_url = "https://www.smurfitwestrock.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.smurfitwestrock.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Smurfit Westrock")
        return documents
