...
class IdexxFetcher(CompanyFetcher):
    """IDEXX Laboratories 爬蟲"""

    company_id = "idexx"
    company_name = "IDEXX Laboratories"
    news_url = "https://www.idexxlaboratories.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.idexxlaboratories.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from IDEXX Laboratories")
        return documents
