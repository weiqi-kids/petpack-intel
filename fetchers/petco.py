"""
Petco Health and Wellness 官網爬蟲
"""
...
class PetcoFetcher(CompanyFetcher):
    """Petco Health and Wellness 爬蟲"""

    company_id = "petco"
    company_name = "Petco Health and Wellness"
    news_url = "https://www.petcohealthandwellness.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.petcohealthandwellness.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Petco Health and Wellness")
        return documents
