"""
Graphic Packaging Holding 官網爬蟲
"""
...
class GraphicPkgFetcher(CompanyFetcher):
    """Graphic Packaging Holding 爬蟲"""

    company_id = "graphic_pkg"
    company_name = "Graphic Packaging Holding"
    news_url = "https://www.graphicpackagingholding.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.graphicpackagingholding.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Graphic Packaging Holding")
        return documents
