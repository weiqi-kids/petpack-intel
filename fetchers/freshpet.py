...
class FreshpetFetcher(CompanyFetcher):
    """Freshpet 爬蟲"""

    company_id = "freshpet"
    company_name = "Freshpet"
    news_url = "https://www.freshpet.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.freshpet.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Freshpet")
        return documents
