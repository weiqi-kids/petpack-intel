...
class ZoetisFetcher(CompanyFetcher):
    """Zoetis 爬蟲"""

    company_id = "zoetis"
    company_name = "Zoetis"
    news_url = "https://www.zoetis.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Zoetis")
        return documents
