...
class ElancoFetcher(CompanyFetcher):
    """Elanco Animal Health 爬蟲"""

    company_id = "elanco"
    company_name = "Elanco Animal Health"
    news_url = "https://www.elancoanimalhealth.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.elancoanimalhealth.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Elanco Animal Health")
        return documents
