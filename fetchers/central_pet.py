...
class CentralPetFetcher(CompanyFetcher):
    """Central Garden & Pet 爬蟲"""

    company_id = "central_pet"
    company_name = "Central Garden & Pet"
    news_url = "https://www.centralgarden&pet.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.centralgarden&pet.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Central Garden & Pet")
        return documents
